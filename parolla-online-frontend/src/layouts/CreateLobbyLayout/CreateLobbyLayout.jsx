...
import styles from './CreateLobbyLayout.module.css';
    ...
    return (
        <div className={styles.lobbyContainer}>
            ...
            <div className={styles.roomNumberContainer}>
                    ...
                    {roomNumber?.map((number) => {
                        return (
                            <div style={{ display: "flex", flexDirection: "column", marginBottom: "30px" }}>
                                { /* Number */}
                                <h1 style={{ margin: "20px 30px 5px 30px" }}>
                                    {number}
                                </h1>
                                {/* Line Under the Number */}
                                <div style={{ width: "50px", height: "5px", margin: "0px 30px 0px 30px", backgroundColor: "black" }}/>    
                            </div>
                        )
                    })}
                </div>
                ...
                { /* Buttons: Copy + Share */}
                <div className={styles.roomNumberButtonContainer}>
                    <button
                ...
                <h3
                    className={styles.roomNumberCopyText}
            ...
            <div className={styles.playerContainer}>
                ...
                {/* Player Count Text */}
                <h3 style={{ position: 'absolute', top: 0, right: 20, fontWeight: 'bold' }}>
